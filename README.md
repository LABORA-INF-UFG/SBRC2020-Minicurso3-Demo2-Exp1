...
```
git clone https://github.com/LABORA-INF-UFG/SBRC2020-Minicurso3-Demo2-Exp1.git
```
...
```
cd SBRC2020-Minicurso3-Demo2-Exp1 && ansible-playbook -K Demo2Exp1.yml  -e  "internet_network_interface=<< internet network interface name>>"
```
